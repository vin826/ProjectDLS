...
import { IconHome, IconArrowLeft, IconInfoCircle,IconSettings } from "@tabler/icons-react";
...
const cards = data.map((card, index) => (
   ...
   return (
    <div className="flex h-screen">
      {/* Sidebar - setOpen is the equivalent of onClose */}
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="flex justify-center items-center bg-gray-50 dark:bg-gray-900 min-h-screen">
         ...
         <div className="w-full h-full py-20 bg-white dark:bg-gray-800">
